          ...
          <div className='max-w-[450px] h-[600px] mx-auto bg-black/80 rounded-lg'>
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              <form onSubmit={handlerFormSubmit} className=' w-full flex flex-col py-4'>
                ...
                <button className='bg-red-600 py-3 my-6 rounded font-sans font-semibold'>Sign Up</button>
                ...
                <p className='my-4'>
                  <span className='text-gray-600 mr-2'>Already Subscribed to Duneflix?</span>
